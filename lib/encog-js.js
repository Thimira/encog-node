...
/**
 * Modified to work with Node.js
 * https://github.com/Thimira/encog-node
 */

/**
 * Modifications for Node.js.
 * defining a top level global variable to act as the parent frame for the ENCOG
 * namespace. This replaces the reference to the 'window' object from the
 * Javascript version.
 */
libParent = {};
 ...
 * @type {*}
 */
var ENCOG = module.exports = ENCOG || {
    /**
...
ENCOG.namespace = function (namespaceString) {
    ...
    /**
     * Modifications for Node.js.
     * setting the defined global 'libParent' as the parent
     */
